...
if __name__ == "__main__":
    ...
    nexus_forge.nodes = []  #  
    nexus_forge.add_node('localhost', 5001)  #  node 2 
    ...
    server_thread = threading.Thread(target=start_server, args=(nexus_forge, 'localhost', 5000))
    server_thread.start()
    ...
    broadcast_block(new_block, nexus_forge.nodes, self_host='localhost', self_port=5000)

    # save and display chain info
